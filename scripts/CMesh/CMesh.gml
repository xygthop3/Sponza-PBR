...
function CMesh(_model=undefined) constructor
{
	...
	static Submit = function ()
	{
		if (VertexBuffer != undefined)
		{
			...
			texture_set_stage(shader_get_sampler_index(_shader, "samp_MetalRoughness"), _metallicRoughness);
			texture_set_stage(shader_get_sampler_index(_shader, "samp_Normal"), _normal);
			shader_set_uniform_f(shader_get_uniform(_shader, "uni_Camera_Position_Pixel"), OTemplate.x,OTemplate.y,OTemplate.z);
